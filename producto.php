...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            ...
            onclick="cargarFormularioCrearProducto()">
        ...
        <div class="row">
                                ...
                                <tbody>
                                    <?php while ($row = $result->fetch_assoc()) : ?>
                                        <tr>
                                            ...
                                            <td><img src="<?php echo $row["ruta_imagen"]; ?>" alt="Imagen del producto" style="width: 50px; height: 50px;"></td>
                                            <td><?php echo $row["activo"] ? 'Sí' : 'No'; ?></td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="eliminar_producto.php?id=<?php echo $row["id_producto"]; ?>" class="btn btn-danger">
                                                        <i class="fas fa-trash"></i> Eliminar</a>
                                                    <a href="actualizar_producto.php?id=<?php echo $row["id_producto"]; ?>" class="btn btn-success">
            ...
            <div class="col-md-3">
                <div class="card text-center mb-3">
                    <img src="https://uxwing.com/wp-content/themes/uxwing/download/e-commerce-currency-shopping/find-product-icon.png" alt="productos" style="width:100%">
                    <div class="container">
                        <h4>Productos</h4>
                    </div>
                </div>
...
<script>
    // Función para cargar el formulario de crear producto
    function cargarFormularioCrearProducto() {
